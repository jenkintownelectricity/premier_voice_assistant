...
from fastapi import FastAPI, File, UploadFile, HTTPException, Depends, Header, Request, WebSocket, WebSocketDisconnect, Form, Body
...
async def delete_voice_clone(
    ...
    Removes both the database record and the audio file from storage.
    """
    try:
        ...
        try:
            ...
            logger.warning(f"Failed to delete audio file (may not exist): {storage_err}")
        ...
        return {"success": True, "message": f"Voice clone '{clone['display_name']}' deleted"}
